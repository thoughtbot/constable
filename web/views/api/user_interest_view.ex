defmodule Constable.Api.UserInterestView do
  ...
  def render("index.json", %{user_interests: user_interests}) do
    %{user_interests: render_many(user_interests, Constable.Api.UserInterestView, "user_interest.json")}
  end

  def render("show.json", %{user_interest: user_interest}) do
    %{user_interest: render_one(user_interest, Constable.Api.UserInterestView, "user_interest.json")}
  end
